...
<body>
    ...
    ?>
        ...
        <a link href='/workspace_4BK_23_24/guitarwars/admin.php'>Zurück zur Admin-Seite</a>;
        ...
        if(isset($_POST['id']) && isset($_POST['nachname']) && isset($_POST['datum']) && isset($_POST['punkte']) && isset($_POST['auswahl'])){
            ...
            if($_POST['auswahl'] == 'ja'){
                ...
                try{
                    ...
                    echo "<br>";
                    echo "<a link href='/workspace_4BK_23_24/guitarwars/admin.php'>Zurück zur Admin-Seite</a>";
